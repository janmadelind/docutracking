...
<body class="theme-red">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">                            
                            <li>
                                <a href="<?php echo base_url('Accounting_table_ongoing'); ?>">
                                    <span>Ongoing</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('Accounting_table_done'); ?>">
                                    <span>Approved</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('Accounting_table_failed'); ?>">
                                    <span>Failed</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="<?php echo base_url('Accounting_notif'); ?>">
                            <i class="material-icons">add_alert</i>
                            <span>Notifications</span>
                        </a>
                    <<!-- /li>           
                        <a href="<?php echo base_url('Accounting_reports'); ?>">
 ...
 <script type="text/javascript">
        $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"<?php echo base_url('Accounting_controller/notification');?>",
                    method:"POST",
                    data:{view:view},
                    dataType:"json",
