                                    ...
                                    <tbody>
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo 
                                                    '<a class="btn bg-red waves-effect" href="'.site_url('ICO_controller/ICO_details/'.$key->PR_No.'').'">'?>View Details </a>
                                                <?php echo 
                                            ...
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <?php echo form_open("ICO_controller/ICO_addPR_status/$key->PR_No"); ?>
                                                        Status:
