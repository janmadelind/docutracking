<section class="content">
        <div class="container-fluid">
            ...
            <div class="row">                
                <div onclick="window.location.href='ICO_table_ongoing'" class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-3 bg-red hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            <?php 
                            if($ICOongoing != NULL){
                                foreach ($ICOongoing as $key) {
                            ?>
                            <div class="number count-to" data-from="0" data-to="<?php echo $key->ICOongoingcount; ?>"  data-speed="1500" data-fresh-interval="20"></div>
                            <?php
                                }
                            }
                            ?>
                ...
                <div onclick="window.location.href='ICO_table_done'" class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-3 bg-red hover-zoom-effect">
                        <div class="icon">
                ...
                <div onclick="window.location.href='ICO_table_failed'" class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-3 bg-red hover-zoom-effect">
                        <div class="icon">
                            <i class="material-icons">assignment_late</i>
                        </div>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo base_url('ICO_controller/ICO_scanPR')?>" method="post">
