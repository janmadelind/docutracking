                                        ...
                                        <div class="modal-dialog modal-sm" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <?php echo form_open("Admin_controller/proc_addPR_mode/$key->PR_No");?>
                                        ...
                                        <?php 
                                            ...
                                            <div class="modal fade" id="reso2'.$key->PR_No.'" tabindex="-1" role="dialog">'; ?>
                                                <div class="modal-dialog modal-sm" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php echo form_open("Admin_controller/proc_addPR_awards/$key->PR_No");?>
                                                ...
                                                <div class="modal fade" id="bidders1'.$key->PR_No.'" tabindex="-1" role="dialog">'; ?>
                                                    <div class="modal-dialog modal-sm" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <?php echo form_open("Admin_controller/proc_addPR_newbidders/$key->PR_No");?>
                                                                <p>Add name of Bidder:</p>
                                                                <input type="text" name="bidders">
                                                ...
                                                <div class="modal fade" id="bidders2'.$key->PR_No.'" tabindex="-1" role="dialog">'; ?>
                                                    <div class="modal-dialog modal-sm" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <?php echo form_open("Admin_controller/addPR_oldbidders/$key->PR_No");?> 
                                            ...
                                            <div class="card" >
                                                <div class="body bg-grey">
                                                    ...
                                                    <!-- <?php  
                                                        echo '<a class="btn bg-red waves-effect" data-toggle="modal" data-target="#amt'.$key->PR_No.'">UPDATE AMOUNT</a>'
                                                    ?>
                                                    7 -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal fade" id="attachments'.$key->PR_No.'" tabindex="-1" role="dialog">'; ?>
                                                <div class="modal-dialog modal-sm" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                        <?php echo form_open("Admin_controller/proc_addPR_attachments/$key->PR_No");?>
                                            ...
                                            <div class="modal fade" id="remarks'.$key->PR_No.'" tabindex="-1" role="dialog">'; ?>
                                                <div class="modal-dialog modal-sm" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                        <?php echo form_open("Admin_controller/proc_addPR_remarks/$key->PR_No");?>
